          ...
          <form id="sign-in-form" class="form" role="form">
            ...
            <div class="form__radio">
            	...
            	<label class="radio" for="Large Egg Nw">Large Egg Nw<span>Dutch Farms, 1 egg (50g)</span></label>
            		<br>
            	<input id="Natural Choice Honey Deli Ham" type="radio" name="favorites" checked />
